...
//console.log(JSON.stringify(req.user));
      var dataObj = { signout: 1, ip: req.ip, social: 'twitter', name: req.user._json.screen_name, url: req.user.photos[0].value, id: req.user.id };
      ...
      con.query(sql, dataObj, function (err, result) {
        ...
        con.query(sqlUpdnull, function (err, result0) {
          ...
          con.query(sqlUpd, function (err, result0) {
            if (err) errorhandler(err);
            console.log(result0.affectedRows + " record(s) updated");
          });
